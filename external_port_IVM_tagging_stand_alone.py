...
import pandas as pd
from utils.read_configs import read_configs
...
def port_array_from_csv(input_file):
    ...
    # Create a text file and save the ports in the specified format
    output_file = 'found_ports'
    with open(output_file, mode='w') as file:
        file.write(','.join(port_values))
...
folder_name = '../data/external_port_IVM_tagging'
nmap_script_path = r'C:\py\infosec-scripts\utils\nmap\nmap_f_from_file.bat'  # No dont change file name, only path, can be .sh as well
nmap_targets_path = r'C:\py\infosec-scripts\data\external_port_IVM_tagging\nmap_targets' # No dont change file name, only path
nmap_results_path = r'C:\py\infosec-scripts\data\external_port_IVM_tagging'
ports_found_externally = fr'{folder_name}\found_ports'
ip_service_df_path = r'C:\py\infosec-scripts\data\external_port_IVM_tagging\nmap_convert_target_results.csv' # No dont change file name, only path
asset_df_path = r'C:\py\infosec-scripts\data\external_port_IVM_tagging\report.csv' # No dont change file name, only path
port_df_path = r'C:\py\infosec-scripts\data\external_port_IVM_tagging\tag_ids.csv' # No dont change file name, only path
slack_channel = 'cs_test'
excluding_move = ['found_ports']
...
try:
    ...
    target_list = extract_row_and_create_file('ip_address', r'C:\py\infosec-scripts\data\external_port_IVM_tagging\report.csv', nmap_targets)
...
try:
    ...
    move_files_to_timestamped_dir(folder_name, [excluding_move])
